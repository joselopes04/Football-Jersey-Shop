...
<body>
    <section class="bg-gray-50 dark:bg-gray-800 min-h-screen flex items-center justify-center">
        <!-- login container -->
        <div class="bg-gray-100 dark:bg-gray-900 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center m-2 my-10">
            <div class="md:w-1/2 px-8 md:px-16">
                ...
                <!-- form -->
                <form id="registrationForm" action="" method="post" class="flex flex-col gap-4">
                    <div id="firstNameDiv">
                        <input id="registrationFirstName" class="p-2 mt-8 rounded-xl w-full border focus:outline-none focus:ring focus:border-blue-800" type="text" name="First name" placeholder="First name(s)">
                        <div class="error text-xs text-red-800"></div>
                    </div>
                    <div id="surnameDiv">
                        <input id="registrationSurname" class="p-2 rounded-xl w-full border focus:outline-none focus:ring focus:border-blue-800" type="text" name="Last name" placeholder="Surname(s)">
                        <div class="error text-xs text-red-800"></div>
                    </div>
                    <div id="emailDiv">
                    ...
                    <div id="checkboxDiv">
                        <div class="flex items-center mb-4">
                            <input id="termsCheckbox" type="checkbox" value="" class="p-2 w-4 h-4 text-blue-800 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="termsCheckbox" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Accept <a class="underline text-blue-400" href="<?php echo route("terms"); ?>">Terms and Conditions</a></label>
                        </div>
                        <div class="error text-xs text-red-800"></div>
                    </div>
                ...
                <div class="mt-3 text-xs flex justify-between items-center text-blue-800 ">
                    ...
                    <a href="<?php echo route("login"); ?>"><button href="index.php" class="py-2 px-3 bg-white border rounded-xl hover:scale-110 duration-300">Do the Login</button></a>
                </div>
            </div>
            <!-- image -->
