...
<body>
    <header class="flex justify-between px-3 bg-slate-200 dark:bg-gray-900 dark:text-white">
        ...
        <!-- Logo End -->
        <!-- MOBILE MENU -->
        <div id="mobileMenu" class="hidden md:hidden fixed top-0 bottom-0 left-0 w-[220px] shadow-2xl transition-all bg-slate-300 dark:bg-gray-900 z-50">
            <div class="py-navbar-item ">
                <a href="<?php echo route(""); ?> "><img src="<?php echo route("images/FJSlogoHorizontal.png"); ?>" style="height: 30px;" alt="Brand Logo"></a>
            </div>
            <ul>
                <li>
                    <a href="<?php echo route(''); ?>" class="flex items-center py-navbar-item px-navbar-item hover:bg-slate-400 dark:hover:bg-slate-700 transition-all">
                ...
                <li>
                    <a href="<?php echo route("leagueView"); ?> " class="flex items-center py-navbar-item px-navbar-item hover:bg-slate-400 dark:hover:bg-slate-700 transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 mr-1">
            ...
            <ul>
                <?php if (!isset($_SESSION['email'])) { ?>
                    <li>
                        <a href=" <?php echo route("loginView"); ?>" class="flex items-center py-navbar-item px-navbar-item hover:bg-slate-400 dark:hover:bg-slate-700 transition-all">
                ...
                <?php } else { ?>
                    <li>
                        <a onclick="dropdwonClicked()" class="flex items-center py-navbar-item px-navbar-item hover:bg-slate-400 dark:hover:bg-slate-700 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                            </svg>
                            Account
                        ...
                        <ul id="dropdownList" class="bg-slate-100 dark:bg-gray-800">
                            <li><a href=" <?php echo route("userAccount"); ?>" class="flex items-center py-navbar-item px-navbar-item hover:bg-slate-400 dark:hover:bg-slate-700 transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
                            ...
                            <li>
                                <a href="<?php echo route("myProducts"); ?>" class="flex items-center py-navbar-item px-navbar-item hover:bg-slate-400 dark:hover:bg-slate-700 transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
                    ...
                    <li>
                        <a href="<?php echo route("shoppingCart"); ?>" class="flex items-center py-navbar-item px-navbar-item hover:bg-slate-400 dark:hover:bg-slate-700 transition-all">
                ...
                <?php } else { ?>
                    <li>
                        <a onclick="dropdwonClicked()" class="flex items-center py-navbar-item px-navbar-item hover:bg-slate-400 dark:hover:bg-slate-700 transition-all">
                            ...
                            <svg id="dropdown" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                            </svg>
                        </a>
                        <ul id="dropdownList2" class="hidden absolute bg-slate-200 dark:bg-gray-900">
                            <li><a href=" <?php echo route("userAccount"); ?>" class="flex items-center py-navbar-item px-navbar-item hover:bg-slate-400 dark:hover:bg-slate-700 transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-1">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
                                    </svg>
