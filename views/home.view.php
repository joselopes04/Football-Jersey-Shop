...
<body class="bg-gray-50 dark:bg-gray-800">
  ...
  <div id="popularProducts" class="my-20">
    <div class="flex flex-row justify-between mx-5">
      <h2 class="text-3xl dark:text-white">Popular</h2>
      <a class="p-2 dark:text-white">
    ...
    <div class="grid grid-flow grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10 mx-5">
      ...
      <div class="shadow-lg rounded-lg">
        <a href="">
          <img src="images/jerseys/portugal/benfica/benfica2223.png" alt="">
        </a>
        <div class="p-5">
          ...
          <div class="flex flex-col xl:flex-row justify-between">
            ...
            <a href="<?php echo route("productView"); ?>" class="flex flex-row justify-center px-3 py-2 my-2 bg-gradient-to-r from-blue-800  to-blue-600 rounded-xl w-36 text-sm text-white hover:scale-105 duration-300">
      ...
      <div class="shadow-lg rounded-lg">
        ...
        <div class="p-5">
          ...
          <div class="flex flex-col sm:flex-row justify-between">
            ...
            <a href="" class="flex flex-row justify-center px-3 py-2 my-2 bg-gradient-to-r from-blue-800  to-blue-600 rounded-xl w-36 text-sm text-white hover:scale-105 duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
              </svg>
              View details
