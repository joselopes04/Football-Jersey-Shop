  ...
  <section class="bg-gray-50 dark:bg-gray-800 min-h-screen flex items-center justify-center">
    ...
    <div class="bg-gray-100 dark:bg-gray-900 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
      <div class="md:w-1/2 px-8 md:px-16">
        ...
        <!-- form -->
        <form id="loginForm" action="<?php echo route("login"); ?>" method="post" onsubmit="return validateLoginInputs()" class="flex flex-col gap-4">
          ...
          <div id="loginPassowrdDiv">
            <div class="relative">
              <input id="passwordLogin" class="p-2 rounded-xl border w-full focus:outline-none focus:ring focus:border-blue-800 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" type="password" name="password" placeholder="Password">
          ...
          <button type="submit" class="bg-blue-800 rounded-xl text-white py-2 hover:scale-105 duration-300">Login</button>
        </form>
        <!-- form end-->


        <div class="mt-5 text-xs border-b border-blue-800 py-4 text-blue-800">
          <a href="<?php echo route("resetPassword"); ?>">Forgot your password?</a>
        </div>
